/* $Id: system.h,v 1.19 2003/10/31 11:24:37 m-a Exp $ */
...
#ifdef __OS2__
//none
#define DIRSEP_C '\\'  //[Define directory separator (C character)])
#define DIRSEP_S "\\"  //[Define directory separator (C string)])
#define CURDIR_S "."   //[Define name of current directory (C string)])
#define EXTSEP_S "."   //[Define file extension separator (C string)])
