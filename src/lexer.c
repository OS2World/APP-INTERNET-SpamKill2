/* $Id: lexer.c,v 1.82 2003/10/31 22:26:51 relson Exp $ */
...
size_t text_decode(word_t *w)
{
	...
	uint len = end - tmp;
       char coding[64]="";
       size_t len_coding = typ - (txt+2);
       bool copy;
       if(len_coding > sizeof(coding) -1)
               len_coding  = sizeof(coding) -1;
       strncpy(coding,txt+2,len_coding);
       coding[len_coding] = 0;
       ...
       if(coding[0])
              init_charset_table(coding,true);
